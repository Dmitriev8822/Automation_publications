...
- Клиент пишет короткие логи о запросах к OpenRouter: начало поиска новостей, успешное получение ответа,
  количество найденных новостей, генерацию поста/изображения и ошибки HTTP-клиента.
