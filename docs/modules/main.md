...
Reminder-job перед отправкой уведомления заново читает пункт контент-плана из БД и проверяет, что его статус всё еще `scheduled`. Если пользователь уже отменил пункт или публикация завершилась до срабатывания reminder-job, уведомление не отправляется повторно; одобрение не снимает пункт с расписания, а публикация выполняется только когда пункт уже due по согласованному времени.
